let businessarr = [
  ...
  //here includes all category
  //crime category books
  {
    name: "Reebeca",
...
let slicedarr = businessarr.slice(0, 4);

const bookcard = slicedarr
  .map((t) => {
    return `
          <div class="mainsec">
              <div class="bookimg"><img src="${t.img}"></div>
                <div class="book-content">
                    ...
                    <div class="description"><h1>Description:</h1><p> ${t.desc}</p></div>
...
const search = () => {
  ...
  if (newarr.length > 0 && newarr.length <= 4) {
    let searchresult = newarr
        ...
        return `
              <div class="mainsec">
                    ...
                    <div class="book-content">
                      ...
                      <divele class="price"><h1> Price: Rs. ${ele.price}</h1></divele
      ...
      .join("");
    books.innerHTML = searchresult;
  }

  if (newarr.length > 4) {
    let slicedresultarr = newarr.slice(0, 4);
    let slicedsearch = slicedresultarr
      .map((ele) => {
        return `
                    <div class="mainsec">
                        <div class="bookimg"><img src="${ele.img}"></div>
