//this is the array that contains object which has name,price,author and description of book with its image path
...
let allbookslist = document.querySelector(".allbookslist");
...
allbookslist.innerHTML = bookcard;
...
const search = () => {
  ...
  if (newarr.length > 0) {
    let searchresult = newarr
      ...
      .join("");
    allbookslist.innerHTML = searchresult;
  }
};
